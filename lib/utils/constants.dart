class AppConstants {
  // Mock API kullanımı (Firebase API aktif olduğunda false olarak ayarlayın)
  static const bool useMockApi = true;
  
  // API Base URL
  static const String _realApiBaseUrl = 'https://iskele360-api.example.com/api';
  static const String _mockApiBaseUrl = 'http://10.0.2.2:3000/api'; // Emülatör için localhost
  static const String _firebaseApiBaseUrl = 'http://127.0.0.1:5001/iskele360v7-7d5d6/us-central1/api';
  
  // WebSocket URL
  static const String _realSocketUrl = 'wss://iskele360-api.example.com';
  ...
  // Kullanıcı Rolleri
  static const String roleSupervisor = 'supervisor'; // Puantajcı
  static const String roleWorker = 'isci'; // İşçi
  static const String roleSupplier = 'supplier'; // Malzemeci
  static const String roleAdmin = 'admin'; // Admin
  
  // Puantaj Durumları
  static const String puantajStatusTamamlandi = 'tamamlandi';
  static const String puantajStatusDevamEdiyor = 'devam_ediyor';
  static const String puantajStatusIptal = 'iptal';
  ...
  // Hata Mesajları
  static const String errorConnection = 'Bağlantı hatası! Lütfen internet bağlantınızı kontrol edin.';
  static const String errorUnauthorized = 'Yetkisiz erişim! Lütfen tekrar giriş yapın.';
  static const String errorServer = 'Sunucu hatası! Lütfen daha sonra tekrar deneyin.';
